...
There’s no bug in this task. Add your own user number after the report name instead of XZ. For example, ‘Z_DEBUG_02_USER01’.

## Steps

1. In **SAP GUI** transaction `SE38`, enter `Z_DEBUG_02_USERXZ`, and click **Display**.  
...
8. Press **Continue** or **F8**. In the **Variables 1** table, double-click on `lt_numbers` again. Examine the values of the internal table.  
9. Navigate back to the main debugger view (press **Back**, or press **F3**, or click on **Desktop 1** / **Desktop 3**).  
10. Press **Continue** or **F8** to let the program finish executing.  
11. Check file **Debugging Solutions**.  
